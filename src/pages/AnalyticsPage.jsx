...
export default function AnalyticsPage() {
  ...
  return (
      ...
      marginBottom: 24
        ...
        {[{
        label: 'Rata-rata Booking/Hari',
        value: '353',
        change: '+8.2%',
        up: true,
        color: 'var(--accent)'
      }, {
        label: 'Tingkat Keberhasilan Scan',
        value: '95.7%',
        change: '+1.1%',
        up: true,
        color: 'var(--green)'
      }, {
        label: 'Rata-rata Durasi Parkir',
        value: '2j 14m',
        change: '-5m',
        up: false,
        color: 'var(--orange)'
      }, {
        label: 'Total Swap Berhasil',
        value: '87',
        change: '+18%',
        up: true,
        color: 'var(--accent2)'
      }].map((k, i) => <div key={i} className="card" style={{
        padding: '18px 20px'
      }}>
            <div style={{
          fontSize: 24,
          ...
          <div className="card-body">
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={MONTHLY_DATA}>
                ...
                <Tooltip content={<CustomTooltip />} />
                <Line type="monotone" dataKey="bookings" name="Booking" stroke="var(--accent)" strokeWidth={2.5} dot={{
                fill: 'var(--accent)',
                r: 4
              }} />
                <Line type="monotone" dataKey="users" name="Pengguna Baru" stroke="var(--accent2)" strokeWidth={2} dot={{
                fill: 'var(--accent2)',
                r: 4
              }} strokeDasharray="5 5" />
      ...
      marginBottom: 20
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            name: 'Lampung City Mall',
            bookings: 745,
            scans: 712,
            swap: 28,
            pct: 96
          }, {
            name: 'Stasiun Tanjungkarang',
            bookings: 421,
            scans: 403,
            swap: 12,
            pct: 96
          }, {
            name: 'UNILA Teknik Elektro',
            bookings: 312,
            scans: 309,
            swap: 8,
            pct: 99
            ...
            borderBottom: '1px solid var(--border)'
              ...
              marginBottom: 6
                ...
                <div className="progress">
                  <div className="progress-bar progress-bar-accent" style={{
                width: r.pct + '%'
              }} />
                </div>
              </div>)}
