    ...
    <div className="card" style={{ marginBottom: 16 }}>
      <div className="card-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 32, height: 32, borderRadius: 10, background: 'var(--accent-glow)', border: '1px solid var(--border2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
...
function Toggle({ label, desc, defaultChecked = true }) {
...
function InputRow({ label, placeholder, defaultValue, type = 'text' }) {
  return (
    ...
    <div>
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          {saved && (
            <div style={{ padding: '8px 16px', background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: 10, fontSize: 13, color: 'var(--green)', fontWeight: 600 }}>
              ✓ Pengaturan disimpan
            </div>
          )}
            ...
            <div style={{ marginTop: 12, marginBottom: 14 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                {['#00D2FF', '#7B61FF', '#22c55e', '#f59e0b', '#ef4444'].map(c => (
                  <div key={c} style={{ width: 28, height: 28, borderRadius: '50%', background: c, cursor: 'pointer', border: c === '#00D2FF' ? '3px solid white' : '2px solid transparent' }} />
                ))}
              </div>
            </div>
          </SettingSection>
      ...
      {/* Info box */}
      <div style={{
        padding: '16px 20px', background: 'rgba(0,210,255,0.05)',
